...
function Home() {
  return (
    <div className="text-left ">
      ...
      <p className="text-center">Nasi mali adnjlcici :) </p>
      <div className="flex ">
      ...
      <p className="p-2">
        U petak 15.11. posle skole, samo treba da spakujes stvari za 2 noc i 2
      ...
      <p className="p-2">Znam da prolazimo kroz tesku fazu ali samo hcou da znas ...</p>
